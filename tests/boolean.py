...
class BoolTransformer(lark.Transformer[Any, BooleanTerm[str]]):
    def negation(self, inner: Any) -> BooleanTerm[str]:
        return Not(inner[0])

    def disjunction(self, inner: Any) -> BooleanTerm[str]:
        return Or(*inner)

    def conjunction(self, inner: Any) -> BooleanTerm[str]:
        return And(*inner)

    def variable(self, name: Any) -> BooleanTerm[str]:
        return Var(name[0])


def parse(inpt: str) -> BooleanTerm[str]:
    return BoolTransformer().transform(parser.parse(inpt))


benchmark_term1 = (
    "((g & ((((~c & ~f & b & a) & (d & ~g) & (c & ~c & ~c)) | f) | ((b & (b & "
)
"~d & ~g)) | ~b | ~h) | c | ~g) & (b & (((a | b | e) & (~f & ~g) & (a & a & ~d) & (g | ~e | "
"~d)) & ((g | g) & f)))) | ((~a & (~g | f | (~b | (~f & g & a & ~d) | (h | ~c) | (g | h | ~e"
" | ~f))) & ~g & (b | ~e)) | ((f | ((f & ~a & a) & ~c) | (h & (~f & d & b & ~b) & (d | g))) "
"& (((a & ~g & c) | (a & a & f & ~b)) & ~b) & (((~e | ~c | g | h) | (~d | ~h | ~a) | (~a & d"
" & h) | (~d | d)) | ((d & h) & (~h | ~h) & (f & f & ~b & h) & a))) | ((((~e & ~d & a) | ~d)"
" & (~c | (f & ~g & e & ~f)) & ((~a & ~f & ~c & ~d) | (~b & ~f) | (~b & ~h & ~a & ~h) | (a &"
" ~d & ~a))) & (((~e | c | ~f | a) | (~a & c & d & ~h) | a) & ((~g | d) | b | (~a & a)) & d "
"& (g & ~g & ~b & (~g | b | ~g))) & ((~f | (~a & ~g) | (~h & ~h & b)) | ~e))) | c)"
benchmark_term2 = (
    "(~x13 & ~x1 & ((((x12 & x1) | ((~x1 & ~x2) & (~x3 & x3 & ~x1 & x3)) | (~x5"
)
" | (x3 | ~x12)) | ((x3 & x1 & ~x4 & ~x11) & (~x9 | x7 | x6) & (~x7 | x13) & ~x8)) & ~x9 & x7"
" & ~x11) | ((((x13 & x1) | x8 | (x10 & ~x2 & x8)) | x11 | (~x11 & (~x9 | x10) & (x2 & ~x3)))"
" | ~x13 | (x1 & ~x0 & ~x10) | (((~x13 | ~x5 | ~x8) & (~x12 | x6 | x13 | ~x6) & (~x7 & ~x9) &"
" (x8 & x7 & x4)) | ((x3 & ~x10 & x12) & x9 & x12) | ~x12 | ~x10)) | (((x13 & ~x9) | (x3 & (~"
"x10 | ~x7) & x13 & (x0 & ~x8)) | ~x7) | (((x11 | ~x7 | ~x8) & (~x12 | ~x2 | ~x4 | ~x3)) | (("
"~x8 | x0 | ~x7 | x1) | ~x1 | ~x12 | (x3 | ~x12)) | x4 | ((~x4 | x5 | x7 | x3) & x5)) | ((x1 "
"& (x13 & x5) & (~x6 | x2 | x9 | x7)) | (~x9 | x3 | (x1 & x6 & x1 & ~x2) | (x4 | ~x6 | ~x8)) "
"| (~x5 & (x13 | ~x8 | x1) & (~x1 & ~x11))) | (((~x11 & ~x1 & x13 & ~x1) & (~x12 | ~x12 | x8)"
" & x8 & x10) | ~x0 | x9)) | (~x4 | (x2 | (~x9 | ~x3)) | x13 | (((x13 & x9 & x3) & ~x11 & (x1"
"0 | ~x8 | x1)) & x9 & (x5 & (~x3 & ~x10 & ~x10) & x5) & ~x4))))"
benchmark_term3 = "(((A & ~B) | C) & (~C | ~A))"
benchmark_term4 = "((x7 | x4) & x3 & ~x8)"
benchmark_term5 = (
    "(((x2 & ((~x4 & ~x4) | (~x11 | x1 | x9) | x7) & ((~x3 | ~x7 | x7 | ~x12) | "
)
"(~x10 | x11 | x1 | x5) | (x1 & x8 & ~x10)) & ((~x12 & ~x2 & x13) & x5)) | ~x1 | (~x8 | ((~x2 "
"& x1 & ~x4) & (~x4 | ~x3 | ~x12) & (x10 | ~x7 | ~x4 | x12)) | ((~x5 & x3 & ~x1) & (x8 & ~x10)"
" & (~x12 | x13) & (~x2 & ~x13))) | ((x9 & (~x4 & ~x13) & (~x3 & ~x5 & ~x3 & ~x9) & (x12 | ~x1"
"3 | x13)) | ((x10 | x5) & (~x1 & x13) & (x7 & x12 & ~x13 & x12) & ~x4) | (~x6 | (x8 & ~x12 & "
"~x4) | (x2 & x11 & ~x0) | (~x7 | x9)) | ~x3)))"
